...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws InterruptedException {
		try {
			...
			Dao dao=new Dao();
			dao.createDatabase(Main.prefSch);
			...
			EventHandler<ActionEvent> changeLanguageEventHandler=new EventHandler<ActionEvent>() 
			{
				...
				public void handle(ActionEvent event) {
					...
					if(language.equals("English"))
					{
						...
						button2.setText("Continue using Sqlite As Schema Name = "+Main.prefSch);
					...
					else if(language.equals("Türkçe"))
					{
						...
						button2.setText("Şema adı = "+Main.prefSch+" olacak şekilde Sqlite kullanarak devam edin");
			...
			if(language==null || language.length()==0) language="Türkçe";
...
//						passwordField.setText("");
			...
			button2=new Button("Continue using Sqlite As Schema Name = "+prefSch);
