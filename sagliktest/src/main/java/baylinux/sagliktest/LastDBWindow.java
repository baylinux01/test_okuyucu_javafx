				...
				public void handle(ActionEvent event) {
					...
					try {
						if(dao.getEmptyCon()!=null)
						{
							...
							Dao.setSqliteDBClassName("org.sqlite.JDBC");
							Dao.setSqliteDBEmptyUrl("jdbc:sqlite");
							Dao.setSqliteDBUrl("jdbc:sqlite:"+Main.prefSch+".sqlite");
							Dao.setClassName(Dao.getSqliteDBClassName());
							Dao.setUrl(Dao.getSqliteDBUrl());
							Dao.setEmptyUrl(Dao.getSqliteDBEmptyUrl());
							Dao.setHost("localhost");
							Dao.setPort("");
							Dao.setPrefSchema(Main.prefSch);
							Dao.setUname("root");
							Dao.setPass("myPass");
							Dao.setMySqlEmptyUrl("jdbc:mysql://"+Host+":"+Port+"/");
							Dao.setMySqlUrl("jdbc:mysql://"+Host+":"+Port+"/"+Main.prefSch);
							Dao.setMariaDBEmptyUrl("jdbc:mariadb://"+Host+":"+Port+"/");
							Dao.setMariaDBUrl("jdbc:mariadb://"+Host+":"+Port+"/"+Main.prefSch);
							Dao.setPostgreEmptyUrl("jdbc:postgresql://"+Host+":"+Port+"/");
							Dao.setPostgreUrl("jdbc:postgresql://"+Host+":"+Port+"/postgres?currentSchema="+Main.prefSch);
							try {
...
//							passwordField.setText("");
						...
						else
						{
							...
							Dao.setMySqlUrl("jdbc:mysql://"+Host2+":"+Port2+"/"+Main.prefSch);
							Dao.setMariaDBEmptyUrl("jdbc:mariadb://"+Host2+":"+Port2+"/");
							Dao.setMariaDBUrl("jdbc:mariadb://"+Host2+":"+Port2+"/"+Main.prefSch);
							Dao.setPostgreEmptyUrl("jdbc:postgresql://"+Host2+":"+Port2+"/");
							Dao.setPostgreUrl("jdbc:postgresql://"+Host2+":"+Port2+"/postgres?currentSchema="+Main.prefSch);
						}}
